...
public class SamakalRss extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "http://bangla.samakal.net/rss.xml";
...
AppConfig appConfig;
    ...
    public SamakalRss(Context context, RecyclerView recyclerView,AppConfig appConfig) {
