...
public class IttefaqRss extends AsyncTask<Void, Void, Void> {
    public boolean WEB_VIEW = false;
    Context context;
    String address = "http://www.ittefaq.com.bd/rss.xml";
...
AppConfig appConfig;
    ...
    public IttefaqRss(Context context, RecyclerView recyclerView,AppConfig appConfig) {
    ...
    public Document Getdata() {
        try {
            ...
            e.printStackTrace();
            WEB_VIEW = true;
            String newsPaperLink ="http://www.ittefaq.com.bd/";
            Intent intent = new Intent(context, BusinessNewsDetails.class);
