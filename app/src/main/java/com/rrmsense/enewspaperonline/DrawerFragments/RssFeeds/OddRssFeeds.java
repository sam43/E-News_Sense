...
import com.rrmsense.enewspaperonline.DrawerFragments.DrawerAdapter.OddNewsAdapter;
...
public class OddRssFeeds extends AsyncTask<Void, Void, Void> {
    Context context;
    ...
    public OddRssFeeds(Context context, RecyclerView recyclerView, AppConfig appConfig) {
