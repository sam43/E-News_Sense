...
import com.rrmsense.enewspaperonline.DrawerFragments.RssFeeds.BanglaRssFeeds.TheindependentbdRss;
import com.rrmsense.enewspaperonline.MainActivity;
import com.rrmsense.enewspaperonline.R;

public class TheindependentbdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TheindependentbdRss rssFeeds = new TheindependentbdRss(getActivity(), recyclerView_bng24,((MainActivity) getActivity()).appConfig);
        rssFeeds.execute();
    ...
    public void onResume() {
        ...
        ((MainActivity) getActivity())
                .setActionBarTitle("The Independent");
