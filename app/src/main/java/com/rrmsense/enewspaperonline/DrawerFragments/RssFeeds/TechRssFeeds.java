...
public class TechRssFeeds extends AsyncTask<Void, Void, Void> {
    Context context;
    //String address = "http://www.livescience.com/home/feed/site.xml";
    String address = "http://gadgets.ndtv.com/rss/feeds";
    AppConfig appConfig;
    ...
    public TechRssFeeds(Context context, RecyclerView recyclerView,AppConfig appConfig) {
