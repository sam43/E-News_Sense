...
public class ObserverbdRss extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "http://www.observerbd.com/rss.php";
...
AppConfig appConfig;
    ...
    public ObserverbdRss(Context context, RecyclerView recyclerView,AppConfig appConfig) {
