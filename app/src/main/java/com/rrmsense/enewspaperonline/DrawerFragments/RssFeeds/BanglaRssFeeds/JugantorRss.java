...
public class JugantorRss extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "http://www.jugantor.com/rss_online.xml";
    ...
    public JugantorRss(Context context, RecyclerView recyclerView,AppConfig appConfig) {
...
/*                            String str = cureent.getTextContent();
                            ...
                            item.setPubDate(cureent.getTextContent().replace("+0600",""));
