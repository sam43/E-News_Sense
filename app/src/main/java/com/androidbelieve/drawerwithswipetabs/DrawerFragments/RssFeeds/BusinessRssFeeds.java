...
import com.androidbelieve.drawerwithswipetabs.DrawerFragments.DrawerAdapter.BusinessNewsAdapter;
...
public class BusinessRssFeeds extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "http://www.theindependentbd.com/rss.xml";
    //String address = "http://feeds.reuters.com/reuters/technologyNews";
    AppConfig appConfig;
    ...
    public BusinessRssFeeds(Context context, RecyclerView recyclerView,AppConfig appConfig) {
