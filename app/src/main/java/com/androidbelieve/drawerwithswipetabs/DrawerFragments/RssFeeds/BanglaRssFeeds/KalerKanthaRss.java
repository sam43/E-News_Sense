...
public class KalerKanthaRss extends AsyncTask<Void, Void, Void> {
    Context context;
    String address = "http://www.kalerkantho.com/rss.xml";
...
AppConfig appConfig;
    ...
    public KalerKanthaRss(Context context, RecyclerView recyclerView,AppConfig appConfig) {
