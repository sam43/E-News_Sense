...
public class TheindependentbdRss extends AsyncTask<Void, Void, Void> {
    Context context;
...
AppConfig appConfig;
    ...
    public TheindependentbdRss(Context context, RecyclerView recyclerView,AppConfig appConfig) {
