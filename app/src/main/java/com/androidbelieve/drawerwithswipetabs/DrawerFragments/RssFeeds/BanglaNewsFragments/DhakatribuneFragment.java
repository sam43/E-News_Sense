...
import com.androidbelieve.drawerwithswipetabs.DrawerFragments.RssFeeds.BanglaRssFeeds.DhakatribuneRss;
...
public class DhakatribuneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        DhakatribuneRss rssFeeds = new DhakatribuneRss(getActivity(), recyclerView_bng24,((MainActivity) getActivity()).appConfig);
        rssFeeds.execute();
    ...
    public void onResume() {
        ...
        ((MainActivity) getActivity())
                .setActionBarTitle("Dhaka Tribune");
